...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 prose prose-sm">
      ...
      <p className="mt-4 text-sm text-[#4b4b4b]">GAG2 Pet Wiki is a fan-made guide website for the Roblox game Grow a Garden 2. We are not affiliated with Roblox Corporation or The Garden Game.</p>
